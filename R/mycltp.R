...
mycltp=function(n,iter,lambda=10,...){
  ...
  hist(w,freq=FALSE,  ylim=c(0,ymax), col=cm.colors(max(6)),
  ...
  barplot(table(y)/(n*iter),col=topo.colors(max(y)), main="Barplot of sampled y", ylab ="Rel. Freq",xlab="y" )
  x=0:max(y)
  plot(x,dpois(x,lambda=lambda),type="h",lwd=5,col=heat.colors(max(y)),
